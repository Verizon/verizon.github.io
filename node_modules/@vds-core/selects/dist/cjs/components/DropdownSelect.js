...
var propTypes = {
   ...
   */
  selectPadding: _propTypes["default"].string,

  /**
   * @ignore defines the space between the label and the dropdown input
   */
  labelMarginBottom: _propTypes["default"].string,
...
var defaultProps = {
  ...
  selectPadding: (0, _javascriptStyleHelpers.calculateRem)(12, 40, 12, 16),
  labelMarginBottom: (0, _javascriptStyleHelpers.calculateRem)(1),
  overflowEllipsis: false,
  errorLabelSpacing: (0, _javascriptStyleHelpers.calculateRem)(4),
...
var LabelWrapper = /*#__PURE__*/_styledComponents["default"].label.withConfig({
  ...
  return hasTooltip ? (0, _javascriptStyleHelpers.calculateRem)(15) : (0, _javascriptStyleHelpers.calculateRem)(16);
}, function (_ref7) {
  var focusState = _ref7.focusState;
  return focusState && "\n    &:focus,\n    &:active {\n      outline: none;\n    }\n  ";
});

var ErrorTextWrapper = /*#__PURE__*/_styledComponents["default"].div.withConfig({
...
var SelectContainer = /*#__PURE__*/_styledComponents["default"].div.withConfig({
...
}, (0, _javascriptStyleHelpers.calculateRem)(1), function (_ref12) {
  var color = _ref12.color;
  return color.coolGray3;
}, (0, _javascriptStyleHelpers.calculateRem)(1), function (_ref13) {
  var color = _ref13.color;
  return color.coolGray3;
}, (0, _javascriptStyleHelpers.calculateRem)(1), function (_ref14) {
  var color = _ref14.color;
  return color.coolGray3;
}, (0, _javascriptStyleHelpers.calculateRem)(1), function (_ref15) {
  ...
  var error = _ref16.error,
      color = _ref16.color;
  return error && "border-left: ".concat((0, _javascriptStyleHelpers.calculateRem)(1), " solid ").concat(color.error, ";\n    border-top: ").concat((0, _javascriptStyleHelpers.calculateRem)(1), " solid ").concat(color.error, ";\n    border-right: ").concat((0, _javascriptStyleHelpers.calculateRem)(1), " solid ").concat(color.error, ";\n    border-bottom: ").concat((0, _javascriptStyleHelpers.calculateRem)(4), " solid ").concat(color.error, ";\n  ");
}, function (_ref17) {
  ...
  var locked = _ref19.locked,
      ...
      color = _ref19.color;
  return (locked || readOnly) && "border: ".concat(readOnlyBorders ? "".concat((0, _javascriptStyleHelpers.calculateRem)(1), " solid ").concat(color.coolGray3) : 'none', ";\n  ");
}, function (_ref20) {
  ...
  var hoverState = _ref21.hoverState,
      ...
      error = _ref21.error,
      color = _ref21.color;
  return hoverState && "\n    &:hover {\n      border-left: ".concat((0, _javascriptStyleHelpers.calculateRem)(1), " solid ").concat(readOnly || disabled ? color.coolGray3 : color.black, ";\n      border-top: ").concat((0, _javascriptStyleHelpers.calculateRem)(1), " solid ").concat(readOnly || disabled ? color.coolGray3 : color.black, ";\n      border-right: ").concat((0, _javascriptStyleHelpers.calculateRem)(1), " solid ").concat(readOnly || disabled ? color.coolGray3 : color.black, ";\n      }\n");
}, function (_ref22) {
  ...
  return focused && !readOnly && !locked && !disabled && "\n    outline: none;\n    border-left: ".concat((0, _javascriptStyleHelpers.calculateRem)(1), " solid ").concat(color.black, ";\n    border-top: ").concat((0, _javascriptStyleHelpers.calculateRem)(1), " solid ").concat(color.black, ";\n    border-right: ").concat((0, _javascriptStyleHelpers.calculateRem)(1), " solid ").concat(color.black, ";\n    border-bottom: ").concat(error ? (0, _javascriptStyleHelpers.calculateRem)(4) : (0, _javascriptStyleHelpers.calculateRem)(1), "\n      solid ").concat(error ? color.error : color.black, ";\n\n  ");
});

var SelectEl = /*#__PURE__*/_styledComponents["default"].select.withConfig({
  ...
  return (0, _javascriptStyleHelpers.calculateRem)(body.letterSpacing);
}, function (_ref28) {
  var selectPadding = _ref28.selectPadding,
      inlineLabel = _ref28.inlineLabel,
      error = _ref28.error;
  return inlineLabel ? error ? (0, _javascriptStyleHelpers.calculateRem)(12, 44, 9, 0) : (0, _javascriptStyleHelpers.calculateRem)(12, 44, 12, 0) : selectPadding;
}, function (_ref29) {
  ...
  return error ? (0, _javascriptStyleHelpers.calculateRem)(9) : (0, _javascriptStyleHelpers.calculateRem)(12);
});

var ComponentContainer = /*#__PURE__*/_styledComponents["default"].div.withConfig({
...
var OptionalLabel = /*#__PURE__*/_styledComponents["default"].span.withConfig({
...
var IconContainer = /*#__PURE__*/_styledComponents["default"].span.withConfig({
  displayName: "IconContainer",
  componentId: "h8azzi-7"
})(_templateObject8(), (0, _javascriptStyleHelpers.calculateRem)(12), function (_ref38) {
  var typescale = _ref38.typescale;
  return typescale === 'VDS' ? (0, _javascriptStyleHelpers.calculateRem)(12) : (0, _javascriptStyleHelpers.calculateRem)(16);
}, function (_ref39) {
  var typescale = _ref39.typescale;
  return typescale === 'VDS' ? (0, _javascriptStyleHelpers.calculateRem)(12) : (0, _javascriptStyleHelpers.calculateRem)(13);
}, function (_ref40) {
...
var InlineLabel = /*#__PURE__*/_styledComponents["default"].label.withConfig({
  displayName: "InlineLabel",
  componentId: "h8azzi-8"
})(_templateObject9(), function (_ref41) {
  var error = _ref41.error;
  return error ? (0, _javascriptStyleHelpers.calculateRem)(12, 4, 9, 12) : (0, _javascriptStyleHelpers.calculateRem)(12, 4, 12, 12);
});

var FlexedRowContainer = /*#__PURE__*/_styledComponents["default"].span.withConfig({
  displayName: "FlexedRowContainer",
  componentId: "h8azzi-9"
})(_templateObject10());

var FlexedColContainer = /*#__PURE__*/_styledComponents["default"].span.withConfig({
...
var HelperText = /*#__PURE__*/_styledComponents["default"].div.withConfig({
  ...
  var helperTextPlacement = _ref43.helperTextPlacement,
      label = _ref43.label;
  return helperTextPlacement === 'right' && "\n    position: relative;\n    width: 50%;\n    padding-top: 0px;\n    padding-left: ".concat((0, _theme.calculateSpacing)('3X'), ";\n  ");
}, function (_ref44) {
  var helperTextPlacement = _ref44.helperTextPlacement;
  return helperTextPlacement === 'bottom' && "\n    padding-top: ".concat((0, _theme.calculateSpacing)('2X'), ";\n  ");
});

var AlignTooltip = /*#__PURE__*/_styledComponents["default"].span.withConfig({
...
var Select = /*#__PURE__*/function (_React$Component) {
  ...
  function Select(props) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "_hideIcon", function () {
      _this.setState({
        iconFocused: false,
        selectFocus: true
      });
    });
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "_showIcon", function () {
      _this.setState({
        iconFocused: true,
        selectFocus: false
      });
    });
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "_renderHelperText", function () {
      ...
      return /*#__PURE__*/_react["default"].createElement(HelperText, {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "renderIcon", function (_ref45) {
      ...
      return /*#__PURE__*/_react["default"].createElement(IconContainer, {
        ...
        inlineLabel: inlineLabel,
        typescale: typescale
      }, !readOnly && /*#__PURE__*/_react["default"].createElement(_icons["default"], {
        tabIndex: -1,
        data: iconConfig,
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "_labelOnClick", function (e) {
  ...
  (0, _createClass2["default"])(Select, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement(ComponentContainer, {
        width: width,
        maxWidth: maxWidth,
        minWidth: minWidth,
        helperTextPlacement: helperTextPlacement,
      ...
      }, label && !inlineLabel && /*#__PURE__*/_react["default"].createElement(LabelWrapper, {
        id: labelId,
        width: width,
      ...
      }, label, /*#__PURE__*/_react["default"].createElement(OptionalLabel, {
        id: labelId,
        disabled: disabled,
        "aria-label": label,
        color: color,
        required: required
      }), (tooltipTitle || tooltipContent) && label && /*#__PURE__*/_react["default"].createElement(AlignTooltip, null, /*#__PURE__*/_react["default"].createElement(Tooltip, {
        size: "small",
        disabled: disabled,
        title: tooltipTitle
      }, tooltipContent)))), /*#__PURE__*/_react["default"].createElement(FlexedRowContainer, null, /*#__PURE__*/_react["default"].createElement(FlexedColContainer, {
        helperText: helperText,
        helperTextPlacement: helperTextPlacement
      ...
      }, inlineLabel && label && /*#__PURE__*/_react["default"].createElement(InlineLabel, {
        error: error,
        tabIndex: -1,
        htmlFor: unique_id
        ...
        bold: true,
        color: disabled ? color.coolGray3 : color.black
      }, label)), /*#__PURE__*/_react["default"].createElement(SelectEl, (0, _extends2["default"])({
      ...
      }), this._renderChildren()), this.renderIcon(this.props)), error && errorText && /*#__PURE__*/_react["default"].createElement(ErrorTextWrapper, {
...
var _default = (0, _utilities.withVDSManager)(Select);
