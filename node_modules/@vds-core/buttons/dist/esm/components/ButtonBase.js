...
})(_templateObject(), calculateRem(44));
var StyledChildWrapper = /*#__PURE__*/styled.span.withConfig({
  ...
  switch (size) {
    case 'tiny':
      return "\n          margin: ".concat(calculateRem(0, 13), ";\n        ");
    ...
    case 'small':
      return "\n          margin-right: ".concat(calculateSideMargin(size, width), ";\n          margin-left: ").concat(calculateSideMargin(size, width), ";\n          padding: ").concat(function (_ref4) {
        ...
        return smallButtonPadding ? calculateRem(6.5, 0) : 0;
      }, ";\n        ");

    case 'block':
      return "\n          display: block;\n          width: 100%;\n          margin-right: ".concat(calculateRem(width === 'autoTight' ? 21 : 42), ";\n          margin-left: ").concat(calculateRem(width === 'autoTight' ? 21 : 42), ";\n        ");
...
var StyledButtonBase = /*#__PURE__*/styled.button.withConfig({
  displayName: "StyledButtonBase",
  componentId: "sc-1dtxg2w-2"
})(_templateObject3(), calculateRem(100), calculateRem(1), function (_ref5) {
  ...
  if (size === 'tiny') {
    return "\n        font-size: ".concat(calculateRem(smallButtonText.fontSize), ";\n        line-height: ").concat(calculateRem(smallButtonText.lineHeight), ";\n        font-family: ").concat(smallButtonText.fontFamily, ";\n      ");
  }
...
var ButtonBase = function ButtonBase(props) {
  ...
  return /*#__PURE__*/React.createElement(StyledButtonBase, _extends({}, props, {
    size: size,
    width: width,
    ...
    "data-loc": dataLoc
  }), hitArea && !disabled && /*#__PURE__*/React.createElement(HitArea, {
    onClick: _onClick
  }), /*#__PURE__*/React.createElement(StyledChildWrapper, {
    display: display,
    size: size,
    width: width,
