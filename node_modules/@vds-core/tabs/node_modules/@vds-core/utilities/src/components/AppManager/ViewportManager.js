...
let desktop = { min: _parsePxStringToInt(breakpoints.lg), max: null };
let tablet = {
  max: _parsePxStringToInt(breakpoints.lg),
  min: _parsePxStringToInt(breakpoints.md),
};
let mobile = { max: _parsePxStringToInt(breakpoints.md), min: null };
...
class ViewportManager {
  ...
  register({ maxMobile = breakpoints.md, maxTablet = breakpoints.lg }) {
    const self = this;
  ...
  unregister({ maxMobile = breakpoints.md, maxTablet = breakpoints.lg }) {
    let desktopQuery = `screen and (min-width:${maxTablet})`;
    let tabletQuery = `screen and (max-width:${maxTablet})`;
    let mobileQuery = `screen and (max-width:${maxMobile})`;
