...
var Content = /*#__PURE__*/styled.span.withConfig({
  displayName: "Content",
  componentId: "sc-1df2i7b-2"
})(_templateObject3());
var StyledVDSTab = /*#__PURE__*/styled(CoreTab).withConfig({
...
export var TabContent = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(TabContent, [{
    ...
    value: function render() {
      ...
      if (!isDesktop || orientation === 'horizontal') {
        return /*#__PURE__*/React.createElement(VDSTab, _extends({
          viewport: viewport,
          index: index,
          label: label
        }, this.props));
