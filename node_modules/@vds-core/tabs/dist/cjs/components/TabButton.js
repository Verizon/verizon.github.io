...
var coreTypescale = _typography.TypographyConfig.getTypescale();
/*
...
var buildAccentStyles = function buildAccentStyles(props) {
  ...
  if (accentFill || indicatorFillTab) {
    styles += "\n      width: ".concat((0, _javascriptStyleHelpers.calculateRem)(80), ";\n      padding-right: 1rem;\n      margin-right: 0;\n    ");
  } else {
    styles += "\n      padding-right: 0;\n    ";
  }

  styles += "\n    border-top: ".concat(position === 'top' ? (0, _javascriptStyleHelpers.calculateRem)(4) : 0, " solid transparent;\n    border-bottom: ").concat(position === 'bottom' ? (0, _javascriptStyleHelpers.calculateRem)(4) : 0, " solid transparent;\n    border-").concat(position, "-color: ").concat(selected ? colorConfig.red : colorConfig.coolGray6, ";\n    transition: width 0.2s ease, background-color 0.2s ease;\n  ");
...
var StyledTabButton = /*#__PURE__*/_styledComponents["default"].button.withConfig({
  ...
  return (0, _javascriptStyleHelpers.calculateRem)(titleConfig.lineHeight);
}, function (_ref4) {
  var titleConfig = _ref4.titleConfig;
  return (0, _javascriptStyleHelpers.calculateRem)(titleConfig.fontSize);
}, function (_ref5) {
  ...
  return focusState && "\n  &:focus:not(:hover) {\n    outline: none;\n    span {\n      position: relative;\n      display: block;\n      height: auto;\n      width: auto;\n      &::after {\n        border: ".concat((0, _javascriptStyleHelpers.calculateRem)(1), " dashed ").concat(colorConfig.black, ";\n        content: '';\n        top: ").concat((0, _javascriptStyleHelpers.calculateRem)(-2), ";\n        bottom: ").concat((0, _javascriptStyleHelpers.calculateRem)(-3), ";\n        left: ").concat((0, _javascriptStyleHelpers.calculateRem)(-3), ";\n        width: calc(100% + ").concat((0, _javascriptStyleHelpers.calculateRem)(4), ");\n        position: absolute;\n      }\n    }\n  }\n  &::-moz-focus-inner, \n  ::-moz-focus-inner {\n    border: 0;\n  }\n  &:focus:hover {\n    outline:none;\n  }\n  ");
}, function (props) {
  return buildAccentStyles(props);
});

var ButtonContent = /*#__PURE__*/_styledComponents["default"].span.withConfig({
  displayName: "ButtonContent",
  componentId: "xumbrb-1"
})(_templateObject2());

var TabWrapper = /*#__PURE__*/_styledComponents["default"].span.withConfig({
...
var TabButton = function TabButton(_ref9) {
  ...
  return /*#__PURE__*/_react["default"].createElement(StyledTabButton, {
    id: "".concat(uniqueId),
    ...
    "data-track": track
  }, /*#__PURE__*/_react["default"].createElement(TabWrapper, null, label));
};
