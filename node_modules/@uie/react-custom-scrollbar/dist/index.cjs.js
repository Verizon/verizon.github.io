...
function (_Component) {
  ...
  _createClass(Scrollbars, [{
    ...
    value: function render() {
      ...
      return React.createElement(tagName, _objectSpread$1({}, props, {
      ...
      }, children), React.cloneElement(renderTrackHorizontal({
      ...
      }, React.cloneElement(renderThumbHorizontal({
        style: thumbHorizontalStyleDefault
      }), {
        ref: function ref(_ref5) {
          _this7.thumbHorizontal = _ref5;
        }
      })), React.cloneElement(renderTrackVertical({
      ...
      }, React.cloneElement(renderThumbVertical({
