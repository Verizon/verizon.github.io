...
class CustomScroll extends Component {
  ...
  componentDidMount() {
    ...
    if (this.innerContainer) {
      this.innerContainer.addEventListener('wheel', this.blockOuterScroll, { passive: false })
    }
  }
  ...
  componentWillUnmount() {
    ...
    if (this.innerContainer) {
      this.innerContainer.removeEventListener('wheel', this.blockOuterScroll)
    }
  }
  ...
  blockOuterScroll = e => {
    if (this.props.allowOuterScroll || !this.innerContainer) {
      return
    }
    ...
    if (this.customScrollbarRef && contentNode.scrollTop + delta <= 0) {
      contentNode.scrollTop = 0
      e.preventDefault()
    } else if (this.customScrollbarRef && contentNode.scrollTop + delta >= maxScroll) {
    ...
    return (
      <div className={`${styles.customScroll} ${this.state.onDrag ? styles.scrollHandleDragged : ''}`}
        ...
        <div className={styles.outerContainer}
          ...
          <div ref={this.setInnerContainerRef}
