/*! VZRF Version 2.20.0 */
window.ParsleyExtend=window.ParsleyExtend||{},window.ParsleyExtend=$vf.extend(window.ParsleyExtend,{asyncSupport:!0,asyncValidators:$vf.extend({"default":{fn:function(e){return"resolved"===e.state()},url:!1},reverse:{fn:function(e){return"rejected"===e.state()},url:!1}},window.ParsleyExtend.asyncValidators),addAsyncValidator:function(e,t,i,n){return this.asyncValidators[e.toLowerCase()]={fn:t,url:i||!1,options:n||{}},this},asyncValidate:function(){return"ParsleyForm"===this.__class__?this._asyncValidateForm.apply(this,arguments):this._asyncValidateField.apply(this,arguments)},asyncIsValid:function(){return"ParsleyField"===this.__class__?this._asyncIsValidField.apply(this,arguments):this._asyncIsValidForm.apply(this,arguments)},onSubmitValidate:function(e){var t=this;if(!0!==e.parsley)return this.submitEvent=$vf.extend(!0,{},e),e instanceof $vf.Event&&(e.stopImmediatePropagation(),e.preventDefault()),this._asyncValidateForm(void 0,e).done(function(){t.submitEvent.isDefaultPrevented()||t.$element.trigger($vf.extend($vf.Event("submit"),{parsley:!0}))})},eventValidate:function(e){new RegExp("key").test(e.type)&&!this._ui.validationInformationVisible&&this.getValue().length<=this.options.validationThreshold||(this._ui.validatedOnce=!0,this.asyncValidate())},_asyncValidateForm:function(e,t){var i=this,n=[];this._refreshFields(),$vf.emit("parsley:form:validate",this);for(var s=0;s<this.fields.length;s++)e&&e!==this.fields[s].options.group||n.push(this.fields[s]._asyncValidateField());return $vf.when.apply($vf,n).always(function(){$vf.emit("parsley:form:validated",i)})},_asyncIsValidForm:function(e,t){var i=[];this._refreshFields();for(var n=0;n<this.fields.length;n++)e&&e!==this.fields[n].options.group||i.push(this.fields[n]._asyncIsValidField(t));return $vf.when.apply($vf,i)},_asyncValidateField:function(e){var t=this;return $vf.emit("parsley:field:validate",this),this._asyncIsValidField(e).done(function(){$vf.emit("parsley:field:success",t)}).fail(function(){$vf.emit("parsley:field:error",t)}).always(function(){$vf.emit("parsley:field:validated",t)})},_asyncIsValidField:function(e,t){var i=$vf.Deferred();return!1===this.isValid(e,t)?i.rejectWith(this):"undefined"!=typeof this.constraintsByName.remote?this._remote(i):i.resolveWith(this),i.promise()},_remote:function(e){var t,i,n=this,s={},r=this.options.remoteValidator||(!0===this.options.remoteReverse?"reverse":"default");if(r=r.toLowerCase(),"undefined"==typeof this.asyncValidators[r])throw new Error("Calling an undefined async validator: `"+r+"`");s[this.$element.attr("name")||this.$element.attr("id")]=this.getValue(),this.options.remoteOptions=$vf.extend(!0,this.options.remoteOptions||{},this.asyncValidators[r].options),t=$vf.extend(!0,{},{url:this.asyncValidators[r].url||this.options.remote,data:s,type:"GET"},this.options.remoteOptions||{}),i=$vf.param(t),"undefined"==typeof this._remoteCache&&(this._remoteCache={}),this._remoteCache[i]||(this._xhr&&"pending"===this._xhr.state()&&this._xhr.abort(),this._xhr=$vf.ajax(t),this._remoteCache[i]=this._xhr),this._remoteCache[i].done(function(t,i,s){n._handleRemoteResult(r,s,e)}).fail(function(t,i,s){"abort"!==i&&n._handleRemoteResult(r,t,e)})},_handleRemoteResult:function(e,t,i){return"function"==typeof this.asyncValidators[e].fn&&this.asyncValidators[e].fn.call(this,t)?void i.resolveWith(this):(this.validationResult=[new window.ParsleyValidator.Validator.Violation(this.constraintsByName.remote,this.getValue(),null)],void i.rejectWith(this))}}),window.ParsleyConfig=window.ParsleyConfig||{},window.ParsleyConfig.validators=window.ParsleyConfig.validators||{},window.ParsleyConfig.validators.remote={fn:function(){return!0},priority:-1},/*!
* Parsleyjs
