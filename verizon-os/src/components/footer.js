  ...
  <footer>
    <div className="inner-footer">
      <div className="navigation">
        <nav>
            <Link to="/support" style={{ textDecoration: 'none' }}><Body color="white" size="medium">Support</Body></Link>
            <Link to="/contacts" style={{ textDecoration: 'none' }}><Body color="white" size="medium">Contacts</Body></Link>
            <Link to="/brands" style={{ textDecoration: 'none' }}><Body color="white" size="medium">Brands</Body></Link>
        </nav>
      </div>
      { <div className="logos">
